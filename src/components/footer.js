const footer = () => {
    return (
        <div className="footer-section ">
            <div className="footer-sec d-flex justify-content-between h-10 text-white align-items-center p-4">
                <ul className="list-inline">
                    <li className="list-inline-item">
                         <a href="https://github.com/soulkod" className="text-decoration-none text-reset">
                    ...
                    <li className="list-inline-item">
                         <a href="https://www.linkedin.com/in/thato-makoela-590751261" className="text-decoration-none text-reset">
                    ...
                    <li className="list-inline-item">
                        <a href="https://www.figma.com/files/team/1417494185716251471/project/278255015/Team-project?fuid=1417494183500434564" className="text-decoration-none text-reset">
                ...
                <p>&copy; 2026 Thato Makoela All rights reserved.</p>
            </div>
        </div>
    );
}
