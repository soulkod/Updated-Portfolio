const Home = () => {
    return (
        <div className="container">
            <div className="container home-section  h-100" >
                <div className="row d-flex align-items-center row-home" >
                    <div className="col-md-6 col-12">
                        <div className="container intro-text">
                            <h3 className='name-label'><b>Thato Solomon Makoela</b></h3>
                            <h1>I'm <span id="example"></span></h1>
                        ...
                        <div className="container intro-text">
                            <ul className="list-inline">
                                <li className="list-inline-item">
                                    <svg xmlns="http://www.w3.org/2000/svg"  height="45px" width="45px" fill="currentColor" className="bi bi-bootstrap" viewBox="0 0 16 16">
                                        <path d="M5.062 12h3.475c1.804 0 2.888-.908 2.888-2.396 0-1.102-.761-1.916-1.904-2.034v-.1c.832-.14 1.482-.93 1.482-1.816 0-1.3-.955-2.11-2.542-2.11H5.062zm1.313-4.875V4.658h1.78c.973 0 1.542.457 1.542 1.237 0 .802-.604 1.23-1.764 1.23zm0 3.762V8.162h1.822c1.236 0 1.887.463 1.887 1.348 0 .896-.627 1.377-1.811 1.377z" />
                                        <path d="M0 4a4 4 0 0 1 4-4h8a4 4 0 0 1 4 4v8a4 4 0 0 1-4 4H4a4 4 0 0 1-4-4zm4-3a3 3 0 0 0-3 3v8a3 3 0 0 0 3 3h8a3 3 0 0 0 3-3V4a3 3 0 0 0-3-3z" />
                                    </svg>
                                </li>
                                <li className="list-inline-item">
                                    <svg xmlns="http://www.w3.org/2000/svg"  height="45" width="45"fill="currentColor" className="bi bi-android2" viewBox="0 0 16 16">
                                ...
                                <li className="list-inline-item">
                                    <svg fill="#000000" height="45" width="45" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div className="col-md-6">
                        <div className="container d-flex justify-content-center">
                            <img src={require('./../assets/IMG_6232.png')} alt="Profile" className="home-img img-fluid border-5 shadow-1" style={{ maxWidth: '250px' }} />
                        </div>
                    </div>
                </div>
            </div>
